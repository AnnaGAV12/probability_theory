...
# Ответ: Statistics = 8.00  Р-value = 0.629
...
# Ответ: Statistics = 9.58  Р-value = 0.008
...
# Ответ: Statistics = 0.00  Р-value = 0.062
# Cтатистически значимых различий нет, нулевая гипотеза не отвергается, препарат не влияет на давление.

# 4) Даны 3 группы  учеников плавания. Есть ли различия между группами?
...
# Ответ: Statistics = 5.47   Р-value = 0.065
